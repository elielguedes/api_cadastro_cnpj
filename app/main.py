...
from app.routers import empresas, estabelecimentos, socios  # Rotas das entidades
...
def carregar_dados_csv():
    ...
    with Session(engine) as session:  # Abre sessão com o banco
        for _, row in df.iterrows():  # Itera sobre as linhas do CSV
            ...
            nome_entidade = row['Entidade']  # Nome da entidade
            cnpj_info = row['UC/CNPJ']  # CNPJ ou código
